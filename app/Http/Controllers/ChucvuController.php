...
{        
    ...
    public function postAddChucVu(Request $request){
        ...
        return redirect('chucvu')->with('status','Đã thêm "' . $request->chucvu_vn . '" thành công!');
        }
        return redirect('chucvu')->with('status','Đã thêm "' . $request->chucvu_vn . '" không thành công!');
    ...
    public function postEditChucvu(Request $request,$id){
        ...
        return redirect('chucvu')->with('status','Đã sửa "' . $request->chucvu_vn . '" thành công!');
        }
        return redirect('chucvu')->with('status','Đã sửa "' . $request->chucvu_vn . '" không thành công!');
    }
