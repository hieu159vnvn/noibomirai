		...
		var html = '<div id="giadinh-'+count+'" class="fields">'+ 								
							...
							'<div class="field two wide column">'+
								'<div class="ui calendar" id="namsinhgd-'+count+'">'+
									'<input type="text" class="namsinhgiadinh" name="namsinhgiadinh[]" required>'+
								'</div>'+
							'</div>'+
							'<div class="field three wide comlum">'+
							...
							'</div>'+
							'<div class="field three wide comlum">'+
								'<input id="thunhap-'+count+'" type="text" name="thunhapgiadinh[]" placeholder="VNĐ" required>'+
							'</div>'+	
