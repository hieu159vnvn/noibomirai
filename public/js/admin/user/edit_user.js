...
$('#username').blur(function (event) {
	...
	$.ajax({
		...
		type: 'POST',
		data: { _token: _token, username: $('#username').val(), action: 'edit', oldValue: $('#username').attr('data-old-value') },
...
$('#email').blur(function (event) {
	...
	$.ajax({
		...
		type: 'POST',
		data: { _token: _token, email: $('#email').val(), action: 'edit', oldValue: $('#email').attr('data-old-value') },
		success: function success(data) {
