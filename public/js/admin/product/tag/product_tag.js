...
var html = '<a href="/admin-dashboard/producttags/add"><button id="addtag" style="margin: -5px 0 0 20px" class="ui labeled icon button green"><i class="plus circle icon"></i>Thêm Thẻ</button></a>';
...
$('.positive').click(function (event) {
	window.location.href = 'producttags/' + $(this).attr('data-tag-id') + '/delete';
});
//});
