  ...
  <div class="ui segments">
        <div class="ui segment">
          <div class="ui secondary menu">
            <div class="left menu">
              <div class="item">
                <p>Có {{count($nghiepdoan)}} nghiệp đoàn</p>
              </div>
            </div>
            @permission('nghiepdoan-create')
              <div class="right menu">
                <div class="item">
                  <a href="{{url('nghiepdoan/add')}}" class="ui labeled icon green button"><i class="plus circle icon"></i>Thêm</a>
                </div>
              </div>
              @endpermission
          </div>
