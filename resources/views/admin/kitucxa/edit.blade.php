...
@section('title', 'Sửa kí túc xá')
@section('PageContent')
    <div class="ui two column centered grid wrap-content-header">
        <h1 class="ui header centered page-title">SỬA PHÒNG {{ $kitucxa->tenphong }}</h1>
    </div>
    @if ($errors->any())
    ...
    <div class="ui two column centered grid main-content">
        <div class="fifteen wide column">
			...
			@endif
            <form class="ui form id-ktx" action="" method="post" name="form_1" id="form" id-ktx="{{$kitucxa->id}}">
                {{ csrf_field() }}
                <div class="field thongtin">
                    <div class="field thongtin">			
                        ...
                        <div class="field">
                            ...
                            <div class="ui input left icon">							
                            <i class="user icon"></i>
                            <input type="number" name="sohocvien" value="{{ $kitucxa->sohocvien }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="field">
                ...
                <div class="ui two column centered grid">
                    <div class="eight wide column">
                        <a href="{{ url('/kitucxa/danhsachphong') }}" class="ui labeled icon button btn-align-left"><i
