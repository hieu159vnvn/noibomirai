...
@section('PageContent')
    <div class="ui two column centered grid wrap-content-header">
        <h1 class="ui header centered page-title">Xem phòng {{ $kitucxa->tenphong }}
            <div class="sub header">
                Tối đa {{ $kitucxa->sohocvien }} học viên
            </div>
        </h1>
    </div>
    @if ($errors->any())
...
@section('JsLibraries')
    ...
    <script>
        ...
        $(document).ready(function() {
            //status
            var idkitucxa = $(".id-ktx").attr('id-ktx');
            ...
            var table = $('#myTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '/datatables/kitucxa/view/'+ idkitucxa,
                columns: [
                    {
                        data: 'ngayvaoktx'
                    },
