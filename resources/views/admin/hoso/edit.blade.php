			...
			{{-- TIENG VIET --}}
						<div class="ui bottom attached tab segment active" data-tab="soyeulylich">			
								...
								@else
									<div class="ui steps">
										<div class="step">
											<img width="70" id="upload-demo-img" @if($hoso->hinhanh) src="{{'/hocviens/'.$year_image.'/'.$month_image.'/'.$hoso->hinhanh}}?rand={{md5(time())}}" @else src="/images/admin/avatar.png"  @endif>
											<input type="hidden" id="feature-image" name="featureImage" value="{{$hoso->hinhanh}}">									
										</div>
									</div>
								@endif
								...
								<div class="fields">
									@if ($hoso->diachi)
									<div class="sixteen wide field  @if($hoso->diachi == null) error @endif">
									...
									@else
									<div class="four wide field  @if($hoso->dchk_dc == null) error @endif">
										<label>địa chỉ (ấp/khu phố)</label>
										<div class="ui input left icon">
											<i class="map outline icon"></i>
											<input type="text" name="dchk_dc" value="{{ $hoso->dchk_dc }}">
										</div>
									</div>
									<div class="four wide field  @if($hoso->dchk_xa == null) error @endif">
										<label>Phường/xã</label>
										<div class="ui input left icon">
											<i class="map outline icon"></i>
											<input type="text" name="dchk_xa" value="{{ $hoso->dchk_xa }}">
										</div>
									</div>
									<div class="four wide field  @if($hoso->dchk_huyen == null) error @endif">
										<label>Quận/Huyện</label>
										<div class="ui input left icon">
											<i class="map outline icon"></i>
											<input type="text" name="dchk_huyen" value="{{ $hoso->dchk_huyen }}">
										</div>
									</div>
									<div class="four wide field">
										<label>Tỉnh thành</label>
					...
					<div class="ui form wrapstatus"  >
						<div class="inline field status" >
						  <div class="ui toggle checkbox cont" >
							@if ($hoso->trangthaidongtienktx==1)
							<input name="stt" type="checkbox" class="cont" idstatus="{{$hoso->id}}" rootstatus="{{$hoso->trangthaidongtienktx}}" @if ($hoso->trangthaidongtienktx == 1) checked="" @endif>
