    ...
    <div class="ui segments">
        <div class="ui segment">
            <div class="ui secondary menu">
                <div class="left menu">
                    <a class="item">
                      <a href="{{url('/hoso')}}" class="ui labeled icon blue button"><i class="sync alternate icon"></i>Làm mới</a>
                    </a>
                </div>
                ...
                <div class="right menu">
                  ...
                  <a class="item">
                    <a href="{{url('/hoso/create')}}" class="ui labeled icon blue button"><i class="plus icon"></i>Thêm</a>
                  </a>
