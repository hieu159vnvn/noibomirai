...
@section('title', 'Danh sách tạp chí')
@section('PageContent')
            ...
            @foreach($magazine as $key => $tt)
              <tr>
                ...
                {{-- @permission('logo-edit')--}}
                  <a href="{{url('magazine/edit/'.$tt->id)}}" class="mini ui icon blue button" title="Sửa"><i class="edit icon"></i></a>
                {{-- @endpermission
