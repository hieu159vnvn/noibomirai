		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="{{url('truonghoc/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
				{{-- @endpermission --}}
			</div> 
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$truonghoc->ten}}" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="tenjp" value="{{$truonghoc->tenjp}}" required>
							</div>
						</div>
						<div class="field">
							<strong>Link</strong>
							...
							<input type="text" name="link" value="{{ $truonghoc->link }}">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<br>
						@if ($truonghoc->image)
							<img src="{{url($truonghoc->image)}}" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						@else
							<img src="{{url('uploads/no-image.jpg')}}" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						@endif						
							<input name="image" type="hidden" value="{{$truonghoc->image}}" id="none_img" class="form-control">
					</div>
					{{-- <div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="{{ $truonghoc->sapxep }}" >
							</div>
						</div>
					</div> --}}
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($truonghoc->stt == 1) checked @endif >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="{{url('truonghoc')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
