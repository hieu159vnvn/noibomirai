  ...
  <div class="sub header">
	...
	<div class="ui secondary menu">
      ...
      <div class="right menu">
        <div class="item">
          <a href="{{url('dclienhe/add')}}" class="ui labeled icon green button"><i class="plus circle icon"></i>Thêm</a>
        </div>
      </div>
      {{-- @endpermission --}}
  </div> 
            ...
            @foreach($dclienhe as $key => $dclh)
              <tr>
                ...
                {{-- @permission('logo-edit')--}}
                  <a href="{{url('dclienhe/' . $dclh->id . '/edit')}}" class="mini ui icon blue button" title="Sửa"><i class="edit icon"></i></a>
                {{-- @endpermission
