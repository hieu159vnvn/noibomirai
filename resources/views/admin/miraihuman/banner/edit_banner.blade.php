		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="{{url('banner/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
				{{-- @endpermission --}}
			</div> 
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
						<div class="field">
							...
							<br>
							@if ($banner->image)
								<img src="{{url($banner->image)}}" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
							@else
							...
							<input name="image" type="hidden" value="{{url($banner->image)}}" id="none_img" class="form-control">
						</div>
						<div class="field">
							<label>Link</label>
							...
							<div class="ui form">
								<div class="inline field">
									<div class="ui toggle checkbox">
										<input name="stt" type="checkbox" tabindex="0" @if ($banner->stt == 1) checked @endif>
					...
					<div class="ui ">
						<div class="eight wide column">
							<a href="{{url('banner')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
