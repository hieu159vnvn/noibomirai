		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				{{-- <div class="right menu">
					<div class="item">
					<a href="{{url('baiviet/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div> --}}
				{{-- @endpermission --}}
			</div> 
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$baiviet->ten}}" required>
							</div>
						</div>
						<div class="field">
							<label>slug (*)</label>
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="slug" value="{{$baiviet->slug}}" required>
							</div>
						</div>
						<div class="field">
							...
							<input type="text" name="tenjp" value="{{ $baiviet->tenjp }}">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<div class="ui bottom attached tab segment active" data-tab="first">
							<textarea name="noidung" class="textarea-1000">{{$baiviet->noidung}}</textarea>
						</div>
						<div class="ui bottom attached tab segment" data-tab="second">
							<textarea name="noidungjp" class="textarea-1000">{{$baiviet->noidungjp}}</textarea>
						</div>
					</div>
					<div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="{{ $baiviet->sapxep }}" >
							</div>
						</div>
					</div>
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($baiviet->stt == 1) checked @endif >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="{{url('baiviet')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
