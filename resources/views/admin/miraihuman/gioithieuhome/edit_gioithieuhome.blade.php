...
@section('title', 'Sửa giới thiệu home')
@section('PageContent')
	<div class="ui two column centered grid wrap-content-header">
		<h1 class="ui header centered page-title">SỬA GIỚI THIỆU HOME</h1>
	</div>	
		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				{{-- <div class="right menu">
					<div class="item">
					<a href="{{url('gioithieuhome/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div> --}}
				{{-- @endpermission --}}
			</div> 
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$gioithieuhome->ten}}" required>
							</div>
						</div>
						<div class="field">
							...
							<input type="text" name="tenjp" value="{{ $gioithieuhome->tenjp }}">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<div class="ui bottom attached tab segment active" data-tab="first">
							<textarea name="noidung" class="textarea-1000">{{$gioithieuhome->noidung}}</textarea>
						</div>
						<div class="ui bottom attached tab segment" data-tab="second">
							<textarea name="noidungjp" class="textarea-1000">{{$gioithieuhome->noidungjp}}</textarea>
						</div>
					</div>
					<div class="field">
						<label>Thumb (*)</label>
						...
						<br>
						@if ($gioithieuhome->image)
							<img src="{{url($gioithieuhome->image)}}" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						@else
							<img src="{{url('uploads/no-image.jpg')}}" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						@endif						
							<input name="image" type="hidden" value="{{$gioithieuhome->image}}" id="none_img" class="form-control">
					</div>
					{{-- <div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="{{ $gioithieuhome->sapxep }}" >
							</div>
						</div>
					</div> --}}
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($gioithieuhome->stt == 1) checked @endif >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="{{url('gioithieuhome')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
