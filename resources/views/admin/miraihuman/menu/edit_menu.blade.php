		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				{{-- <div class="right menu">
					<div class="item">
					<a href="{{url('menu/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div> --}}
				{{-- @endpermission --}}
			</div>
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$menu->ten}}" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="tenjp" value="{{$menu->tenjp}}" required>
							</div>
						</div>
					</div>
					<div class="two fields">
						<div class="field">
							...
							<input type="text" name="link" value="{{ $menu->link }}" readonly>
							</div>
						</div>
					</div>
					{{-- <div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="{{ $menu->sapxep }}" >
							</div>
						</div>
					</div> --}}
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($menu->stt == 1) checked @endif >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="{{url('menu')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
