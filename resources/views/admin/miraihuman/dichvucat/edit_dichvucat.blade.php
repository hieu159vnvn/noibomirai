...
@section('title', 'Sửa danh sách dịch vụ')
@section('PageContent')
	<div class="ui two column centered grid wrap-content-header">
		<h1 class="ui header centered page-title">SỬA DANH SÁCH DỊCH VỤ</h1>
	</div>	
		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="{{url('dichvucat/add')}}" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
				{{-- @endpermission --}}
			</div> 
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$dichvucat->ten}}" required>
							</div>
						</div>
						<div class="field">
							<label>slug (*)</label>
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="slug" value="{{$dichvucat->slug}}" required>
							</div>
						</div>
						<div class="field">
							...
							<input type="text" name="tenjp" value="{{ $dichvucat->tenjp }}">
							</div>
						</div>
					</div>
					<div class="two fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="description" value="{{$dichvucat->description}}">
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="language icon"></i>
							<input type="text" name="descriptionjp" value="{{$dichvucat->descriptionjp}}">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<br>
						@if ($dichvucat->image)
							<img src="{{url($dichvucat->image)}}" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						@else
							<img src="{{url('uploads/no-image.jpg')}}" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						@endif						
							<input name="image" type="hidden" value="{{$dichvucat->image}}" id="none_img" class="form-control">
					</div>
					<div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="{{ $dichvucat->sapxep }}" >
							</div>
						</div>
					</div>
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($dichvucat->stt == 1) checked @endif >
