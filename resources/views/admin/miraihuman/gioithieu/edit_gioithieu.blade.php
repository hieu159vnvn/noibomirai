				...
				<div class="field thongtin">			
					{{-- <div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="{{$gioithieu->ten}}" required>
							</div>
						</div>
						<div class="field">
							<label>slug (*)</label>
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="slug" value="{{$gioithieu->slug}}" required>
							</div>
						</div>
						<div class="field">
							...
							<input type="text" name="tenjp" value="{{ $gioithieu->tenjp }}">
							</div>
						</div>
					</div> --}}
					<div class="field">
						...
						<div class="ui bottom attached tab segment active" data-tab="first">
							<textarea name="noidung" class="textarea-1000">{{$gioithieu->noidung}}</textarea>
						</div>
						<div class="ui bottom attached tab segment" data-tab="second">
							<textarea name="noidungjp" class="textarea-1000">{{$gioithieu->noidungjp}}</textarea>
						</div>
					</div>
						...
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" @if ($gioithieu->stt == 1) checked @endif >
