				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="user icon"></i>
							<input type="text" name="chucvu_vn" value="{{$chucvu->chucvu_vn}}" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="user icon"></i>
							<input type="text" name="chucvu_jp" value="{{ $chucvu->chucvu_jp }}" required>
							</div>
						</div>
					</div>
					<div class="field">
						<label>Ghi chú (Nếu có)</label>
						<textarea rows="10" name="ghichu" placeholder="Nội dung...">{{ $chucvu->ghichu }}</textarea>
					</div>
