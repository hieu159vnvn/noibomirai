...
@section('PageContent')
	<div class="ui two column centered grid wrap-content-header">
		<div id="content-header" class="thirteen wide column">
			...
			<h1 class="ui header centered page-title">Thêm Danh Mục Sản Phẩm Mới</h1>
		</div>
	</div>
			...
			<form class="ui form" action="" method="post">
				...
				<div class="field">
				 ...
				 <div style="display: none;" class="field">
					...
					<input type="text" id="category-price" name="categoryPrice" placeholder="Giá trên m2" value="{{ old('categoryPrice') }}">
				</div>
				<div class="field">
				...
				<div class="field">
					...
					<textarea rows="4" id="product-description" name="productDescription" placeholder="Mô tả của danh mục">{{ old('productDescription') }}</textarea>
				</div>
				<div class="field">
				...
				<a href="{{url('admin-dashboard/productcategories')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách Danh Mục</a>
				<button type="submit" class="ui labeled icon button blue btn-align-right"><i class="plus circle icon"></i>Thêm Danh Mục</button>
			</form>
		</div>
	</div>
