...
@section('title', 'Sửa Thẻ ' . $tag->tag_name)
@section('PageContent')
	
	<div class="ui two column centered grid wrap-content-header">
		<div id="content-header" class="thirteen wide column">
			<div class="callback-link">
				<a href="{{url('admin-dashboard/producttags')}}" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách Thẻ</a>
			</div>
...
@endsection
@section('JsLibraries')
  <script src="{{url('js/admin/product/tag/edit_product_tag.js')}}"></script>
@endsection