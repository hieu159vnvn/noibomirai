					...
					<form class="ui form" action="" method="post" name="form_1">
						...
						<div class="field thongtin">
							...
							<div class="three fields">
								{{-- <div class="field">
									<label>Thuế</label>
									<input type="number" name="thue" value="{{ $donhang->thue }}" readonly="" >
								</div>
								<div class="field">
									<label>Bảo hiểm</label>
									<input type="number" name="baohiem" value="{{ $donhang->baohiem }}" readonly="" >
								</div>
								<div class="field">
									<label>Tiền nhà</label>
									<input type="number" name="tiennha" value="{{ $donhang->tiennha }}" readonly="" >
								</div> --}}
								<div class="field">
	...
	<div class="body">
		<table width="1125" border="1" cellspacing="0" style="border: 1px solid black; border-top: 2px solid black; border-right: 2px solid black">
		  ...
		  <tr>
		    ...
		    <td style="text-align: center;"><img src="{{$hs->hinhanh}}" height="50"></td>
