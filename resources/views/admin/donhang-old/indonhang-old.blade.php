  ...
  <div class="ui segment">
    <div id="indonhang">
      ...
      <table class="in" width="794" cellspacing="0"  >
        <tr class="border-none">
          ...
          <p>Điện thoại: 08. 66863208  ; Fax: 08.38733268  Email: contact@miraihuman.com </p></td>
        </tr>
    ...
    {{--    <tr>
        ...
        <tr class="border-none">
          ...
          <td style="text-align: center;"><strong> Chủ tịch Công ty</strong></td>
        </tr>
        <tr class="border-none">
          <td >&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="border-none">
          <td>&nbsp;</td>
          <td style="text-align: center;"><strong> Lê Hữu Tuấn</strong></td>
          <td style="text-align: center;"><strong> Nguyễn Tấn Thanh</strong></td>
        </tr>
      </table>
      </body>
    </div>
