...
<div class="phone_mobi hidden-lg hidden-md">
  <ul>
      <li><a class="blink_me" href="tel:{{$header->hotline1}}"><i class="fa fa-phone" aria-hidden="true"></i>Gọi điện</a></li>
      <li><a href="sms:{{$header->hotline1}}"><i class="fa fa-comments" aria-hidden="true"></i>Nhắn tin</a></li>
      <li><a href="{{url('lien-he')}}"><i class="fa fa-map-marker" aria-hidden="true"></i>Chỉ đường</a></li>
  </ul>
</div>
{{-- GOI DIEN --}}
  </footer>
