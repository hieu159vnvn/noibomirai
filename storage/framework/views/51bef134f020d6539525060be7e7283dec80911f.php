        ...
        <div class="ui segment">
          <div class="ui secondary menu">
              <div class="right menu">
		        <a href="<?php echo e(url('nhanvien')); ?>" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
							   	...
							   	<script type="text/javascript">									
										...
										<div class="four fields">
											...
											<div class="field">
												...
												<div class="ui input left icon">
													...
													<input class="dienthoai" type="text" name="dienthoai" value="<?php echo e(old('dienthoai')); ?>" required>
												</div>
											</div>
											...
											<div class="field">
												<label>Trình độ</label>
												 <div class="ui input left icon">
													...
													<input type="text" name="trinhdo" value="<?php echo e(old('trinhdo')); ?>">
												</div>
											</div>
											<div class="field">
												<label>Chuyên môn</label>
												<div class="ui input left icon">
													<input type="text" name="chuyenmon" value="<?php echo e(old('chuyenmon')); ?>">
												</div>
											</div>
											<div class="field">
												...
												<div class="ui input left icon">
													...
													<input type="text" name="ngoaingu" value="<?php echo e(old('ngoaingu')); ?>" >
												</div>
											</div>
											<div class="field">
												...
												<div class="ui calendar" >
												    <div class="ui input left icon">
													  <i class="calendar icon"></i>
													  <input class="ngayvaolam"  type="text" name="ngayvaolam" value="<?php echo e(old('ngayvaolam')); ?>" required>
												    </div>
												</div>
											</div>
										</div>					
									...
									<div class="two fields">
										<div class="field">
											...
											<textarea rows="10" name="kinhnghiem" placeholder="Nội dung..."><?php echo e(old('kinhnghiem')); ?></textarea>
										</div>
										<div class="field">
