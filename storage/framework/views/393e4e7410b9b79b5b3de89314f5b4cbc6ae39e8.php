<?php $__env->startSection('title', 'Sửa Chức vụ'); ?>
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
						<div class="field">
							...
							<br>
							<?php if($logo->image): ?>
								<img src="<?php echo e(url($logo->image)); ?>" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
							<?php else: ?>
								<img src="<?php echo e(url('uploads/no-image.jpg')); ?>" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
							<?php endif; ?>
							
							<input name="image" type="hidden" value="<?php echo e(url($logo->image)); ?>" id="none_img" class="form-control">
						</div>
						<div class="field">
							<div class="ui form">
								<div class="inline field">
									<div class="ui toggle checkbox">
										<input name="stt" type="checkbox" tabindex="0" <?php if($logo->stt == 1): ?> checked <?php endif; ?>>
					...
					<div class="ui ">
						<div class="eight wide column">
							<a href="<?php echo e(url('logo')); ?>" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
...
<script src="fancybox/vhn_customs/config_Fancybox.js"></script>
  ...
  <script src="<?php echo e(url('js/admin/logo/add_logo.js')); ?>"></script>
<?php $__env->stopSection(); ?>
