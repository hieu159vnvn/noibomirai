...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
            ...
            <div class="form-group">
              ...
              <select name="get-value" class="form-control selectnv">
                ...
                <?php $__currentLoopData = $nhanvien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($nv->id); ?> - <?php echo e($nv->email); ?> - <?php echo e($nv->hoten); ?>"><?php echo e($nv->hoten); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Email:</strong>
                <?php echo Form::text('email', null, array('placeholder' => 'Email','class' => 'form-control', 'id' => 'email')); ?>
