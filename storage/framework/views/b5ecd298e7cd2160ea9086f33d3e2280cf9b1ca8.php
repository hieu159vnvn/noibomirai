<?php $__env->startSection('title', 'Sửa tạp chí'); ?>
<?php $__env->startSection('PageContent'); ?>
	<div class="ui two column centered grid wrap-content-header">
		<h1 class="ui header centered page-title">SỬA TẠP CHÍ</h1>
	</div>	
		...
		<div class="fifteen wide column">
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field">
						...
						<i class="link icon"></i>
						<input type="text" name="link" value="<?php echo e($item->link); ?>">
						</div>
					</div>
				</div>		
				<div class="ui ">
					<div class="eight wide column">
						<a href="<?php echo e(url('magazine')); ?>" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
