<?php $__env->startSection('title', 'Xem phòng'); ?>
<?php $__env->startSection('PageContent'); ?>
    <div class="ui two column centered grid wrap-content-header">
        <h1 class="ui header centered page-title">Xem phòng <?php echo e($kitucxa->tenphong); ?>

            <div class="sub header">
                Tối đa <?php echo e($kitucxa->sohocvien); ?> học viên
            </div>
        </h1>
    </div>
    <?php if($errors->any()): ?>
