...
<?php $__env->startSection('PageContent'); ?>
    ...
    <div class="ui two column centered grid main-content">
        <div class="fifteen wide column">
            <form class="ui form" action="" method="post" name="form_1" id="form" data_id=<?php echo e($dt->id); ?>>
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <div class="ui input left icon">
                                <i class="user icon"></i>
                                <input type="text" name="ten_lop_hoc" value="<?php echo e($dt->ten_lop_hoc); ?>" required>
                            </div>
                        </div>
                        <div class="field">
                            ...
                            <div class="ui calendar" id="date-only">
                                <div class="ui input left icon">
                                    ...
                                    <input type="text" name="ngay_khai_giang" value="<?php echo e($dt->ngay_khai_giang); ?>" required>
                                </div>
                                <div class="ngay-sinh">
                                </div>
                            </div>
                    ...
                    <div class="two fields">
                            ...
                            <select name="gvcn">
                                ...
                                <?php $__currentLoopData = $giaovien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($gv->id == $dt->gvcn): ?>
                                        <option selected value="<?php echo e($gv->id); ?>"><?php echo e($gv->hoten); ?></option>
                                    <?php else: ?>
                                        <option value="<?php echo e($gv->id); ?>"><?php echo e($gv->hoten); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="coso">
                                ...
                                <option <?php if($dt->coso == 3): ?> selected <?php endif; ?>
                ...
                <div class="ui two column centered grid">
                    <div class="eight wide column">
                        <a href="<?php echo e(url('daotao')); ?>" class="ui labeled icon button btn-align-left"><i
    ...
    <div class="ui tiny chuyen-modal modal">
        ...
        <select class="ui dropdown" id="id_lop_chuyen">
            ...
            <?php $__currentLoopData = $lophoc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($item->id); ?>"><?php echo e($item->ten_lop_hoc); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <div class="actions">
