<?php $__env->startSection('title', 'Sửa giới thiệu home'); ?>
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="<?php echo e($gioithieuhome->ten); ?>" required>
							</div>
						</div>
						<div class="field">
							...
							<input type="text" name="tenjp" value="<?php echo e($gioithieuhome->tenjp); ?>">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<div class="ui bottom attached tab segment active" data-tab="first">
							<textarea name="noidung" class="textarea-1000"><?php echo e($gioithieuhome->noidung); ?></textarea>
						</div>
						<div class="ui bottom attached tab segment" data-tab="second">
							<textarea name="noidungjp" class="textarea-1000"><?php echo e($gioithieuhome->noidungjp); ?></textarea>
						</div>
					</div>
					<div class="field">
						<label>Thumb (*)</label>
						...
						<br>
						<?php if($gioithieuhome->image): ?>
							<img src="<?php echo e(url($gioithieuhome->image)); ?>" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						<?php else: ?>
							<img src="<?php echo e(url('uploads/no-image.jpg')); ?>" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						<?php endif; ?>						
							<input name="image" type="hidden" value="<?php echo e($gioithieuhome->image); ?>" id="none_img" class="form-control">
					</div>
						...
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" <?php if($gioithieuhome->stt == 1): ?> checked <?php endif; ?> >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="<?php echo e(url('gioithieuhome')); ?>" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
