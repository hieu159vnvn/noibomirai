  ...
  <div class="ui segments">
      <div class="ui segment">
        <table id="data-table" class="ui selectable celled striped table">
          ...
          <tbody>
            <?php $__currentLoopData = $tuvan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="bg-red">
                ...
                <td><div class="ui toggle checkbox">
                  <input type="checkbox" data-tuvan="<?php echo e($item->id); ?>"<?php if($item->tinhtrang == 1): ?> checked <?php endif; ?>>
                  <label></label>
                </div></td>
              </tr>
