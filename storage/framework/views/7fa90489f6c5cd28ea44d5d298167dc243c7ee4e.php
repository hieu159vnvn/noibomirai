  ...
  <div class="ui segments">
        <div class="ui segment">
          <div class="ui secondary menu">
            <div class="left menu">
              <div class="item">
                <p>Có <?php echo e(count($nghiepdoan)); ?> nghiệp đoàn</p>
              </div>
            </div>
            <?php if (\Entrust::can('nghiepdoan-create')) : ?>
              <div class="right menu">
                <div class="item">
                  <a href="<?php echo e(url('nghiepdoan/add')); ?>" class="ui labeled icon green button"><i class="plus circle icon"></i>Thêm</a>
                </div>
              </div>
