<?php $__env->startSection('title', 'Sửa mạng xã hội'); ?>
		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="<?php echo e(url('mangxahoi/add')); ?>" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
			...
			<form class="ui form" action="" method="post" name="form_1">
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="ten" value="<?php echo e($mangxahoi->ten); ?>" required>
							</div>
						</div>
						<div class="field">
							<strong>Link</strong>
							...
							<input type="text" name="link" value="<?php echo e($mangxahoi->link); ?>">
							</div>
						</div>
					</div>
					<div class="field">
						...
						<br>
						<?php if($mangxahoi->image): ?>
							<img src="<?php echo e(url($mangxahoi->image)); ?>" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						<?php else: ?>
							<img src="<?php echo e(url('uploads/no-image.jpg')); ?>" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						<?php endif; ?>						
							<input name="image" type="hidden" value="<?php echo e($mangxahoi->image); ?>" id="none_img" class="form-control">
					</div>
					<div class="four fields">
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="sort icon"></i>
							<input type="number" name="sapxep" value="<?php echo e($mangxahoi->sapxep); ?>" >
							</div>
						</div>
					</div>
					<div class="field">
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" <?php if($mangxahoi->stt == 1): ?> checked <?php endif; ?> >
				...
				<div class="ui ">
					<div class="eight wide column">
						<a href="<?php echo e(url('mangxahoi')); ?>" class="ui labeled icon button btn-align-left"><i class="arrow left icon"></i>Danh Sách</a>
