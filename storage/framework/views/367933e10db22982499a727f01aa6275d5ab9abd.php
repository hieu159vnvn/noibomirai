    ...
    <div id="indonhang">
      ...
      <table class="in" width="794" cellspacing="0"  >
        <tr class="border-none">
          <td style="width: 260px; text-align: center;"><img width="160" src="<?php echo e(url('images/admin/logo.png')); ?>"></td>
        ...
        <tr class="border-none">
          <td colspan="3" style="text-align: center; font-size: 34px;"><strong>THÔNG BÁO ĐƠN HÀNG - <?php echo e($donhang->tendonhang); ?></strong></td>
        </tr>
        <tr class="border-none">
        ...
        <tr style="height: 50px;">
          ...
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;">
            <strong class="an-hien"><?php if($doitac): ?><?php echo e($doitac->tencongty); ?> <?php endif; ?></strong>
          </td>
        </tr>
        <tr>
          <td><strong> Địa chỉ</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;">
            <?php echo e($donhang->diachi); ?>
        ...
        <tr>
          ...
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;">
            <?php if($donhang->tieudethem): ?>
              <?php if($nganhnghe): ?>
              <?php echo e($nganhnghe->nganhnghe_vn); ?> - <?php echo e($donhang->tieudethem); ?>

              <?php endif; ?>
            <?php else: ?>
              <?php if($nganhnghe): ?>
              <?php echo e($nganhnghe->nganhnghe_vn); ?> 
              <?php endif; ?> 
            <?php endif; ?>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2" style="border-right: 1px solid;text-transform: uppercase;"><?php echo e($donhang->thoigian); ?></td>
        </tr>
        <tr>
          <td><strong> Lương cơ bản</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"><?php echo e($donhang->luongcoban); ?></td>
        </tr>
        
        <tr>
          <td><strong> Các khoản khấu trừ</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> <?php echo e($donhang->khautru); ?> </td>
        </tr>
        <tr>
          <td><strong> Lương thực nhận sau khi trừ chi phí</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"><?php echo e($donhang->luongthuclanh); ?></td>
        </tr>
    
        <tr>
          <td><strong> Ngày tuyển</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> Từ ngày: <?php echo e($donhang->ngaytuyenbd); ?> - đến ngày: <?php echo e($donhang->ngaytuyenkt); ?> </td>
        </tr>
        <tr>
          <td><strong> Số người cần tuyển</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> <?php echo e($donhang->soluongtuyen); ?></td>
        </tr>
        <tr>
          <td><strong> Dự kiến XC</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> <?php echo e($donhang->dukienxc); ?></td>
        </tr>
        <tr>
          <td><strong> Trình độ</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> <?php echo e($donhang->trinhdo); ?></td>
        </tr>
        <tr>
          <td><strong> Yêu cầu khác</strong></td>
          <td colspan="2" style="border-right: 1px solid; text-transform: uppercase;"> <?php echo e($donhang->yeucau); ?></td>
        </tr>
        <tr class="border-none">
...
<?php $__env->startSection('JsLibraries'); ?>
  <script src="<?php echo e(url('js/admin/donhang/create_donhang.js')); ?>"></script>
<?php $__env->stopSection(); ?>
