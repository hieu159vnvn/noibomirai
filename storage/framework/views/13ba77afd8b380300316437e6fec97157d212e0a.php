		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="<?php echo e(url('fbfooter/add')); ?>" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<input type="text" name="link" value="<?php echo e($fbfooter->link); ?>">
							</div>
						</div>
					</div>
						...
						<div class="ui form">
							<div class="inline field">
								<div class="ui toggle checkbox">
									<input name="stt" type="checkbox" <?php if($fbfooter->stt == 1): ?> checked <?php endif; ?> >
