<?php $__env->startSection('title', 'Dịch sang tiếng Nhật'); ?>
...
?>
    ...
    <div class="sub header">
      Dịch học viên : <span class="ui teal label"><?php echo e($hoso->hoten); ?></span> sang tiếng Nhật
    </div>
    </h2>
						...
						<div class="ui bottom attached tab segment active" data-tab="soyeulylich">			
										...
										<div class=" fields">
											<div class="four wide field">
												...
												<div class="ui input left icon">							
													<i class="user icon"></i>
													<input type="text" name="hoten" placeholder="<?php echo e($hoso->hoten); ?>" data-content="<?php echo e($hoso->hoten); ?>" required>
												</div>
											</div>							
											<div class="three wide field">		
												...
												<div class="ui input left icon">
													...
													<input type="text" name="noisinh" value="<?php echo e(khongdau($hoso->noisinh)); ?>" data-content="<?php echo e($hoso->noisinh); ?>" >
												</div>
											</div>
											<div class="field">
										...
										<div class="fields">					
											...
											<div class="twelve wide field">
												...
												<div class="ui input left icon">
													...
													<input type="text" name="diachi" placeholder="<?php echo e(khongdau($hoso->diachi)); ?>" value="" data-content="<?php echo e($hoso->diachi); ?>" >
												</div>
											</div>
											<?php else: ?>
											<div class="three wide field">
												...
												<div class="ui input left icon">
													<i class="map outline icon"></i>
													<input type="text" name="dchk_dc" placeholder="<?php echo e(khongdau($hoso->dchk_dc)); ?>" value="<?php echo e(khongdau($hoso->dchk_dc)); ?>" data-content="<?php echo e($hoso->dchk_dc); ?>" >
												</div>
											</div>
											...
											<div class="three wide field">
												...
												<div class="ui input left icon">
													<i class="map outline icon"></i>
													<input type="text" name="dchk_xa" placeholder="<?php echo e(khongdau($hoso->dchk_xa)); ?>" value="<?php echo e(khongdau($hoso->dchk_xa)); ?>" data-content="<?php echo e($hoso->dchk_xa); ?>" >
												</div>
											</div>
											<div class="one wide field">
												<label>--</label>
											...
											<div class="three wide field">
												...
												<div class="ui input left icon">
													<i class="map outline icon"></i>
													<input type="text" name="dchk_huyen" placeholder="<?php echo e(khongdau($hoso->dchk_huyen)); ?>" value="<?php echo e(khongdau($hoso->dchk_huyen)); ?>" data-content="<?php echo e($hoso->dchk_huyen); ?>" >
												</div>
											</div>
											<div class="one wide field">
												<label>--</label>
								...
								<div class="five fields">
									...
									<div class="field">
										...
										<div class="ui input left icon">
											<i class="eye icon"></i>
											<input type="text" name="mattrai" placeholder="<?php echo e($hoso->mattrai); ?>" data-content="<?php echo e($hoso->mattrai); ?>">
										</div>
									</div>
									<div class="field">
										...
										<div class="ui input left icon">
											...
											<input type="text" name="matphai" placeholder="<?php echo e($hoso->matphai); ?>" data-content="<?php echo e($hoso->matphai); ?>">
										</div>
									</div>
								</div>
							</div>	
								...
								<div id="hoctap" class="three fields" style=" margin: 0em -0.5em;">
										...
										<div class="two fields">
											<div class="field">
												<div class="ui calendar">
													...
													<input type="text" name="thoigianhocbd[]" value="09-<?php echo e($ht->thoigianbd); ?>" class="thoigianhocbd" data-content="<?php echo e($ht->thoigianbd); ?>">
												    </div>
											    </div> 
										    </div>													
											<div class="field">
												<div class="ui calendar">
												    <div class="ui input left icon">
												      <i class="calendar icon"></i>
												      <input type="text" name="thoigianhockt[]" value="05-<?php echo e($ht->thoigiankt); ?>" class="thoigianhockt" data-content="<?php echo e($ht->thoigiankt); ?>">
												    </div>
											    </div> 
											</div>
										</div>
									...
									<div class="field">
										<div class="ui input left icon">
											...
											<?php if($numhoctap > 2): ?> 
												<input type="text" name="tentruong[]" value="<?php echo e(khongdau($ht->tentruong)); ?>"  placeholder="<?php echo e($ht->tentruong); ?>" data-content="<?php echo e($ht->tentruong); ?>">
											<?php else: ?>
												<input type="text" name="tentruong[]"  value="<?php echo e(replace(khongdau($ht->tentruong))); ?>"   placeholder="<?php echo e($arrhoctap[$numhoctap]); ?>" data-content="<?php echo e($ht->tentruong); ?>">
											<?php endif; ?>
									...
									<div class="field">
										<div class="ui grid">
											<div class="twelve wide column">
												<div class="ui input left icon">
													<i class="map icon"></i>
													<input type="text" name="diachitruong[]" value="<?php echo e(khongdau($ht->diachi)); ?>"  placeholder="<?php echo e($ht->diachi); ?>" data-content="<?php echo e($ht->diachi); ?>">
												</div>
											</div>
										...
										<div class="two fields">
											...
											<div class="field">
												...
												<div class="ui input left icon">
													...
													<input type="text" name="nhatngu" id="show_nhatngu" placeholder="<?php echo e($hoso->nhatngu); ?>" data-content="<?php echo e($hoso->nhatngu); ?>">
												</div>
											</div>
											</div>
									...
									<?php $__currentLoopData = $lamviec; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<div id="congviec" class="three fields" style=" margin: 0em -0.5em;">
												...
												<div class="two fields">
													<div class="field">
														<div class="ui calendar">
														    <div class="ui input left icon">
														      <i class="calendar icon"></i>
														      <input type="text" name="thoigianlamviecbd[]" value="<?php echo e($lv->thoigianbd); ?>" class="thoigianhocbd" data-content="<?php echo e($lv->thoigianbd); ?>">
														    </div>
													    </div> 
												    </div>														
													<div class="field">
														<div class="ui calendar">
														    <div class="ui input left icon">
														      <i class="calendar icon"></i>
														      <input type="text" name="thoigianlamvieckt[]" value="<?php echo e($lv->thoigiankt); ?>" class="thoigianhockt" data-content="<?php echo e($lv->thoigiankt); ?>">
														    </div>
													    </div> 
													</div>
												</div>
											...
											<div class="field">
												<div class="ui input left icon">
													<i class="building icon"></i>
													<input type="text" name="tencongty[]" value="<?php echo e(khongdau($lv->tencongty)); ?>" placeholder="<?php echo e($lv->tencongty); ?>" data-content="<?php echo e($lv->tencongty); ?>">
												</div>
											</div>
											<div class="field">
												<div class="ui input left icon">
													<i class="briefcase icon"></i>
													<input type="text" name="ndcongviec[]"  placeholder="<?php echo e($lv->congviec); ?>" data-content="<?php echo e($lv->congviec); ?>">
												</div>
											</div>
										</div>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="ttnguoithan" data-count="1" > 		
		...
		<?php $__currentLoopData = $nguoithan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $nt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div id="congviec" class="three fields" style=" margin: 1em -0.5em;">
				<div class="field">	
					<div class="field">
						<div class="ui calendar">
							<div class="ui input left icon">
								<i class="calendar icon"></i>
								<input type="text" name="hotennguoithan[]" value="<?php echo e(khongdau($nt->hoten)); ?>" data-content="<?php echo e($nt->hoten); ?>">
							</div>
						</div> 
					</div>
				</div>
				<div class="field">
					<div class="ui input left icon">
						<i class="building icon"></i>
						<input type="text" name="tuoinguoithan[]"  placeholder="<?php echo e(khongdau($nt->tuoi)); ?>" value="<?php echo e(khongdau($nt->tuoi)); ?>" data-content="<?php echo e($nt->tuoi); ?>">
					</div>
				</div>
				<div class="field">
					<div class="ui input left icon">
						<i class="briefcase icon"></i>
						<input type="text" name="quanhenguoithan[]" value="<?php echo e(khongdau($nt->quanhe)); ?>" placeholder="<?php echo e($nt->quanhe); ?>" data-content="<?php echo e($nt->quanhe); ?>">
					</div>
				</div>
			</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="two fields thuctap">
		<div class="field">
			...
			<label></label>
			<textarea rows="3" name="mucdich" id="show_mucdich" placeholder="<?php echo e($hoso->mucdich); ?>"  data-content="<?php echo e($hoso->mucdich); ?>"></textarea>
		</div>
		<div class="field">
			...
			<label></label>
			<textarea rows="3" name="muctieu" id="show_muctieu" placeholder="<?php echo e($hoso->muctieu); ?>" data-content="<?php echo e($hoso->muctieu); ?>"></textarea>
		</div>
	</div>
								...
								<div class="two fields">
									<div class="field">
										...
										<textarea rows="3" name="sothich" placeholder="<?php echo e($hoso->sothich); ?>" data-content="<?php echo e($hoso->sothich); ?>"></textarea>
									</div>
									<div class="field">
										<label>Điểm mạnh</label>
										<textarea rows="3" name="diemmanh" placeholder="<?php echo e($hoso->diemmanh); ?>" data-content="<?php echo e($hoso->diemmanh); ?>"></textarea>
									</div>
								</div>
								...
								<div id="giadinh" data-count="1"> 
									...
									<?php $__currentLoopData = $giadinh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $gd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<div id="giadinh">
											<div class="fields">	 								
												<div class="field two wide column">
													<input type="text" name="quanhegiadinh[]"  placeholder="<?php echo e($gd->quanhe); ?>" data-content="<?php echo e($gd->quanhe); ?>">									
												</div>
												<div class="field four wide column">
													<input type="text" name="hotengiadinh[]" value="<?php echo e(khongdau($gd->hoten)); ?>" data-content="<?php echo e($gd->hoten); ?>">
												</div>
												<div class="field two wide column">									
													<div class="ui calendar">
													      <input type="text" name="namsinhgiadinh[]" value="<?php echo e($gd->namsinh); ?>" data-content="<?php echo e($gd->namsinh); ?>" class="namsinh">
													</div>
												</div>
												<div class="field two wide column">
													<input type="text" name="congviecgiadinh[]"  placeholder="<?php echo e($gd->congviec); ?>" data-content="<?php echo e($gd->congviec); ?>">
												</div>
						
												<div class="field four wide column">
													<div class="ui grid">
														<div class="ten wide column">
															<input type="text" name="noilamviecgiadinh[]" value="<?php echo e(khongdau($gd->noilamviec)); ?>" placeholder="<?php echo e($gd->noilamviec); ?>" data-content="<?php echo e($gd->noilamviec); ?>">
														</div>
														<div class="six wide column">
												...
												<div class="field two wide column">
													<input type="text" name="thunhapgiadinh[]" value="<?php echo e($gd->luong); ?>" data-content="<?php echo e($gd->luong); ?>" class="thunhap">
												</div>
											</div> 	
										</div>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
