<?php $__env->startSection('title', 'Sửa cảm nhận'); ?>
		...
		<div class="fifteen wide column">
			...
			<div class="ui secondary menu">
				...
				<div class="right menu">
					<div class="item">
					<a href="<?php echo e(url('camnhan/add')); ?>" class="ui labeled icon button"><i class="plus circle icon"></i>Thêm mới</a>
					</div>
				</div>
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="edit icon"></i>
							<input type="text" name="tenhocvien" value="<?php echo e($camnhan->tenhocvien); ?>" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="nganhnghe" value="<?php echo e($camnhan->nganhnghe); ?>" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="edit icon"></i>
							<input type="text" name="nganhnghejp" value="<?php echo e($camnhan->nganhnghejp); ?> ">
							</div>
						</div>
					...
					<div class="field">
						...
						<div class="ui input left icon">							
						<i class="language "></i>
						<textarea name="noidung" value="<?php echo e($camnhan->noidung); ?>" required><?php echo e($camnhan->noidung); ?></textarea>
						</div>
					</div>
					<div class="field">
						...
						<div class="ui input left icon">							
						<i class="language "></i>
						<textarea name="noidungjp" value="<?php echo e($camnhan->noidungjp); ?>"><?php echo e($camnhan->noidung); ?></textarea>
						</div>
					</div>
					<div class="field">
						<label>Thumb</label>
						...
						<br>
						<?php if($camnhan->image): ?>
							<img src="<?php echo e(url($camnhan->image)); ?>" alt="" id="prev_img" class="medium  ui image bordered img-thumbnail">
						<?php else: ?>
							<img src="<?php echo e(url('uploads/no-image.jpg')); ?>" alt="" id="prev_img" class="medium ui image bordered img-thumbnail ">
						<?php endif; ?>						
							<input name="image" type="hidden" value="<?php echo e($camnhan->image); ?>" id="none_img" class="form-control">
					</div>
