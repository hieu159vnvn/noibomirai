...
<script src="https://cdn.rawgit.com/mdehoog/Semantic-UI/6e6d051d47b598ebab05857545f242caf2b4b48c/dist/semantic.min.js"></script>
	...
	<div class="ui two column centered grid wrap-content-header">
		<h1 class="ui header centered page-title">SỬA CHỨC VỤ</h1>
	</div>	
				...
				<div class="field thongtin">			
					<div class="two fields">
						<div class="field">
							...
							<i class="user icon"></i>
							<input type="text" name="chucvu_vn" value="<?php echo e($chucvu->chucvu_vn); ?>" required>
							</div>
						</div>
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="user icon"></i>
							<input type="text" name="chucvu_jp" value="<?php echo e($chucvu->chucvu_jp); ?>" required>
							</div>
						</div>
					</div>
					<div class="field">
						<label>Ghi chú (Nếu có)</label>
						<textarea rows="10" name="ghichu" placeholder="Nội dung..."><?php echo e($chucvu->ghichu); ?></textarea>
					</div>
