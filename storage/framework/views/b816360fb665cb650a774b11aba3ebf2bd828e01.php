<?php $__env->startSection('title', 'Thêm Địa Chỉ Liên Hệ'); ?>
				...
				<div class="field thongtin">			
						...
						<div class="two fields">
							...
							<div class="field">
								...
								<div class="ui input left icon">							
								<i class="language icon"></i>
								<input type="text" name="diachijp" value="<?php echo e(old('diachijp')); ?>" >
								</div>
							</div>
						</div>
						...
						<div class="field">
							...
							<div class="ui input left icon">							
							<i class="map icon"></i>
							<input type="text" name="bando" value="<?php echo e(old('bando')); ?>" >
							</div>
						</div>
						<div class="four fields">
							<div class="field">
