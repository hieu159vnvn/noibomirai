      ...
      <table id="data-table" class="ui selectable celled striped table">
          ...
          <tbody>
            <?php
                $key=0;
            ?>
            <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $th): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo e(url('menu/' . $th->id . '/edit')); ?>" class="mini ui icon blue button" title="Sửa"><i class="edit icon"></i></a>
...
<script>
  ...
  <script> status_delete('menu'); </script>
