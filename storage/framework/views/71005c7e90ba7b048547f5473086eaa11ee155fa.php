						...
						<div class="ui bottom attached tab segment active" data-tab="soyeulylich">
								...
								<div class="four fields">
									<div class="field">
										...
										<i class="user icon"></i>
										<input type="text" id="hoten" name="hoten" value="<?php echo e(old('hoten')); ?>" required>
										</div>
									</div>
									<div class="field">
										...
										<div class="ui calendar">
										    <div class="ui input left icon">
										      ...
										      <input id="ngaysinh" name="ngaysinh" value="<?php echo e(old('ngaysinh')); ?>" required>
										    </div>
										</div>										
									...
									<div class="field">
										...
										<div class="ui input left icon">
											...
											<input type="tel" id="phone" name="dienthoai" value="<?php echo e(old('dienthoai')); ?>">
										</div>
									</div>
									<div class="field">
										...
										<div class="ui input left icon">
											<i class="mobile alternate icon"></i>
											<input type="tel" id="phone1" name="dtnguoithan" value="<?php echo e(old('dtnguoithan')); ?>">
										</div>
									</div>
								</div>
								...
								<div class="four fields">
									<div class="four wide field">
										...
										<div class="ui input left icon">
											...
											<input type="text" name="dchk_dc" value="<?php echo e(old('dchk_dc')); ?>">
										</div>
									</div>
									<div class="four wide field">
										...
										<div class="ui input left icon">
											<i class="map outline icon"></i>
											<input type="text" name="dchk_xa" value="<?php echo e(old('dchk_xa')); ?>">
										</div>
									</div>
									<div class="four wide field">
										...
										<div class="ui input left icon">
											<i class="map outline icon"></i>
											<input type="text" name="dchk_huyen" value="<?php echo e(old('dchk_huyen')); ?>">
										</div>
									</div>
									<div class="four wide field">
								...
								<div class="four fields">
									...
									<div class="field">
										...
										<div class="ui input left icon">
											...
											<input type="text" name="honnhan" value="<?php echo e(old('honnhan')); ?>">
										</div>
									</div>
									<div class="field">
										<label>Bệnh án</label>
										<div class="ui input left icon">
											...
											<input type="text" name="benhan" value="<?php echo e(old('benhan')); ?>">
										</div>
									</div>
									<div class="field">
										...
										<div class="ui input left icon">
											...
											<input type="text" name="tongiao" value="<?php echo e(old('tongiao')); ?>">
										</div>
									</div>
								</div>
								<div class="five fields">
									<div class="field">
										...
										<div class="ui right labeled input">
												<input type="number" name="chieucao" value="<?php echo e(old('chieucao')); ?>">
									...
									<div class="field">
										...
										<div class="ui right labeled input">
												<input type="number" name="cannang" value="<?php echo e(old('cannang')); ?>">
											<div class="ui basic label">
										    kg
										  	</div>
									 	</div>						
									...
									<div class="field">
										...
										<div class="ui input left icon">
											<i class="eye icon"></i>
											<input type="text" name="mattrai" value="<?php echo e(old('mattrai')); ?>">
										</div>
									</div>
									<div class="field">
										...
										<div class="ui input left icon">
											<i class="eye icon"></i>
											<input type="text" name="matphai" value="<?php echo e(old('matphai')); ?>">
										</div>
									</div>
								</div>
							</div>	
								...
								<div class="three fields ngoaingu">
								    ...
								    <div class="field">
								        ...
								        <input type="text" name="nhatngu" value="<?php echo e(old('nhatngu')); ?>">
								    </div>
								    <div class="field">
								    	<label>Khác</label>
								    	<div class="ui input left icon">
								    		<i class="language icon"></i>
								        	<input type="text" name="ngoaingukhac" value="<?php echo e(old('ngoaingukhac')); ?>">
								        </div>
								    </div>
								</div>
								...
								<div id="ttnguoithan" data-count="1" style="display: none">
									<div id="ttnguoithan-1" class="three fields">
										...
										<div class="field">
											<label>Quan hệ</label>
											<input type="text" name="quanhenguoithan[]" value="<?php echo e(old('quanhenguoithan')); ?>" >
										</div>
										<div class="icon_action">
								...
								<div class="two fields thuctap">
									<div class="field">
										...
										<textarea rows="3" name="mucdich" placeholder="Nội dung"><?php echo e(old('mucdich')); ?></textarea>
									</div>
									<div class="field">
										<label>Mục tiêu sau khi về nước</label>
										<textarea rows="3" name="muctieu" placeholder="Nội dung"><?php echo e(old('muctieu')); ?></textarea>
									</div>
								</div>
								<div class="two fields">
									<div class="field">
								...
								<div class="two fields">
									<div class="field">
										...
										<textarea rows="3" name="sothich" placeholder="Nội dung..."><?php echo e(old('sothich')); ?></textarea>
									</div>
									<div class="field">
										<label>Điểm mạnh</label>
										<textarea rows="3" name="diemmanh" placeholder="Nội dung..."><?php echo e(old('diemmanh')); ?></textarea>
									</div>
								</div>
